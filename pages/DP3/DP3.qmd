...
<button onclick="checkAnswer('q1', 'Excellent', 'feedback1')">Check Answer</button>
<div id="feedback1" style="margin-top: 8px;"></div>
...
<button onclick="checkAnswer('q2', 'Developing', 'feedback2')">Check Answer</button>
<div id="feedback2" style="margin-top: 8px;"></div>
...
<button onclick="checkAnswer('q3', 'Outstanding', 'feedback3')">Check Answer</button>
...
<button onclick="checkAnswer('q4', 'Outstanding', 'feedback4')">Check Answer</button>
<div id="feedback4" style="margin-top: 8px;"></div>
...
<button onclick="checkAnswer('q5', 'Fair', 'feedback5')">Check Answer</button>
<div id="feedback5" style="margin-top: 8px;"></div>
...
<button onclick="checkFairAnswer()">Check Answer</button>
<div id="fair_feedback" style="margin-top: 8px;"></div>

<div id="fair_explanation" style="display: none; margin-top: 20px;">
### Why this is *Fair* (but feels advanced)
