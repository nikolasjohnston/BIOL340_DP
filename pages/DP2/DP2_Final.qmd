...
In this second dry practical, we’ll extend those skills by working with **real experimental data** that you generated in the wet lab. Specifically, we’ll use your results from the **subcellular fractionation practical**, where you separated healthy and diseased cells into mitochondrial and cytosolic fractions, then measured protein concentration and enzyme activity.
...
> This dataset has: - Absorbance readings every 10 seconds for each sample - The reaction rate already calculated - Protein concentration from the Bradford assay
...
### [What does this tell you about the rate of the reaction?]{style="color:red"}
